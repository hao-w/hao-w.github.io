...
<link rel="canonical" href="/node_modules/bootstrap/" />
<meta property="og:url" content="/node_modules/bootstrap/" />
<meta property="og:site_name" content="hao-w.github.io" />
<script type="application/ld+json">
{"headline":"hao-w.github.io","@type":"WebPage","url":"/node_modules/bootstrap/","@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<ul>
  ...
  <li>Install with <a href="https://yarnpkg.com/">yarn</a>: <code class="highlighter-rouge">yarn add bootstrap@4.3.1</code></li>
  <li>Install with <a href="https://getcomposer.org/">Composer</a>: <code class="highlighter-rouge">composer require twbs/bootstrap:4.3.1</code></li>
  <li>Install with <a href="https://www.nuget.org/">NuGet</a>: CSS: <code class="highlighter-rouge">Install-Package bootstrap</code> Sass: <code class="highlighter-rouge">Install-Package bootstrap.sass</code></li>
</ul>
...
<p>Documentation search is powered by <a href="https://community.algolia.com/docsearch/">Algolia’s DocSearch</a>. Working on our search? Be sure to set <code class="highlighter-rouge">debug: true</code> in <code class="highlighter-rouge">site/docs/4.3/assets/js/src/search.js</code> file.</p>

<h3 id="running-documentation-locally">Running documentation locally</h3>

<ol>
  <li>Run through the <a href="https://getbootstrap.com/docs/4.3/getting-started/build-tools/#tooling-setup">tooling setup</a> to install Jekyll (the site builder) and other Ruby dependencies with <code class="highlighter-rouge">bundle install</code>.</li>
  <li>Run <code class="highlighter-rouge">npm install</code> to install Node.js dependencies.</li>
  <li>Run <code class="highlighter-rouge">npm start</code> to compile CSS and JavaScript files, generate our docs, and watch for changes.</li>
